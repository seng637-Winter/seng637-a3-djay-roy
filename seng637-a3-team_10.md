...
Coverage-based testing or white-box testing has the following advantages and disdvantages:
...
The work division for the old assignment 2 methods are the same for this assignment.

| Class         | Method                       | Tester   |
|---------------|------------------------------|----------|
| Range         | `intersects()`               | Tejpreet |
| Range         | `scale()`                    | Munal    |
| Range         | `expandToInclude()`          | Dhananjay|
| Range         | `expand()`                   | Amey     |
| Range         | `shift()`                    | Harshil  |
| DataUtilities | `calculateColumnTotal()`     | Tejpreet |
| DataUtilities | `createNumberArray2D()`      | Munal    |
| DataUtilities | `createNumberArray()`        | Dhananjay|
| DataUtilities | `calculateRowTotal()`        | Amey     |
| DataUtilities | `getCumulativePercentages()` | Harshil  |

# 9 Any difficulties encountered, challenges overcome, and lessons learned from performing the lab

One of the most significant takeaways from this assignment was that our tests, regardless of the testing approach, might not be sufficient to uncover all software bugs. As a result, it becomes crucial to assess the coverage of our test cases over the System Under Test (SUT) code. Some challenges we faced were with coverage tools not being easily integrated with Eclipse.
